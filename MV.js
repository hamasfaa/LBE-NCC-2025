//////////////////////////////////////////////////////////////////////////////
//
//  MV.js - WebGL Math Library for Computer Graphics
//
//////////////////////////////////////////////////////////////////////////////
...
function subtract( u, v )
{
    ...
    if ( u.matrix && v.matrix ) {
        ...
        if ( u.length != v.length ) {
            throw "subtract(): vectors are not the same dimension";
        }
...
function mult( u, v )
{
    ...
    if ( u.matrix && v.matrix ) {
        ...
        if ( u.length != v.length ) {
            throw "mult(): matrix-vector dimensions do not match";
        }
...
function normalize( u, excludeLastComponent )
{
    ...
    if ( !isFinite(len) ) {
        throw "normalize: vector has zero length";
    }
...
{
    if ( typeof s !== "number" ) {
        throw "mix: the last paramter must be a number";
    }
...
{
    if ( !Array.isArray(u) ) {
        throw "scale: second parameter is not a vector";
    }
